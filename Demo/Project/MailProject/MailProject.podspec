...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://git.oschina.net/TestForGroup/mailproject"
  ...
  s.source       = { :git => "https://git.oschina.net/TestForGroup/mailproject.git", :tag => s.version.to_s }
  ...
  s.source_files  = "MailProject/MailProject/**/*.{h,m}"
